...
const navigationMenuTriggerStyle = cva(cn(
  ...
  "text-sm text-muted-foregroundhover:bg-accent hover:text-accent-foreground",
  ...
  "ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 transition-[color,box-shadow]",
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon
        className="relative top-[1px] ml-1 size-3 transition duration-300 group-data-[state=open]:scale-y-[-1]"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "rounded-md border shadow md:w-[var(--radix-navigation-menu-viewport-width)] transition-all",
          className
        )}
        {...props}
      />
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "rounded-sm p-2 text-sm transition-[color,box-shadow] focus-visible:ring-4",
